...
public class PatientService {
	...
	public static Model simulateLoadPatient(Model model) {
		...
		ResultPrediction readmission = ResultPredictionDAO.getResult("readm", "test1234");
		...
		ResultPrediction dpm = ResultPredictionDAO.getResult("dpm", "test1234");
		...
		ResultPrediction dvt = ResultPredictionDAO.getResult("dvt", "test1234");
